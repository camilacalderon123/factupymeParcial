...
public class Prueba {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * "Av 0 # 0-78", "angelycamilacg@ufps.edu.co", "3219810616", "Juridico",
		 * "Regimen", 1), new Factura("20211111SDSDFASDFA3424534", new
		 * GregorianCalendar(2021, 11, 11).getTime(), new GregorianCalendar(2025, 11,
		 * 11).getTime(), 3, 45, (byte) 1, "SebastianSanchez", 1, 1, 1), new
		 * DetalleFactura(1, "CUFEDSA", 1, 1), new RangoNumeracion(24551, new Date(),
		 * 1876401818, 24551, 50000, 20001, "FE"));
		 */
			  ...
			  "N. de Santander", "Cucúta", "Av 0 # 0-78", "angelycamilcg@ufps.edu.co",
